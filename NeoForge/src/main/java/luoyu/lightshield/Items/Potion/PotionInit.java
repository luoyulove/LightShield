...
public class PotionInit {
    ...
    public static final DeferredHolder<Potion, ShieldMaxPotion> POTION_SHIELD_MAX = register("shield_max", ShieldMaxPotion::new);
    public static final DeferredHolder<Potion, ShieldRegenPotion> POTION_SHIELD_REGEN = register("shield_regen", ShieldRegenPotion::new);
}
